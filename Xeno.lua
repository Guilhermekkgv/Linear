...
function Linux.SaveConfig(name)
    if not name or name == "" then
        return false, "Nome de configuração inválido"
    end
    ...
    local success, result = pcall(function()
        ...
        if writefile then
            ...
            return false, "Função writefile não disponível"
        end
    end)
    ...
    if success and result == true then
        ...
        return false, result or "Erro ao salvar configuração"
    end
end
...
function Linux.DeleteConfig(name)
    ...
    local success, result = pcall(function()
        if delfile and isfile(Linux.ConfigFolder .. "/" .. name .. ".json") then
            ...
            return false, "Arquivo de configuração não encontrado ou função delfile não disponível"
        end
    end)
    ...
    if success and result == true then
        ...
        return false, result or "Erro ao excluir configuração"
    end
end
...
function Linux.LoadConfigList()
    ...
    local success, result = pcall(function()
        if listfiles and isfolder(Linux.ConfigFolder) then
            ...
            return false, "Função listfiles não disponível ou pasta não encontrada"
        end
    end)
...
function Linux.Create(config)
    ...
    if config.ConfigSave ~= false then
        ...
        SettingsTab.Section({Name = "Configurações"})
        ...
        local configListDropdown = SettingsTab.Dropdown({
            ...
            Default = Linux.SavedConfigs[1] or "Nenhuma configuração",
        ...
        SettingsTab.Button({
            Name = "Create Config",
            Callback = function()
                local success, message = Linux.SaveConfig(Linux.CurrentConfig)
                if success then
                    Linux:Notify({
                        Title = "Configuração Salva",
                        Content = "Configuração '" .. Linux.CurrentConfig .. "' salva com sucesso!",
                        Duration = 3
                    })
                    ...
                    Linux:Notify({
                        ...
                        Content = message or "Erro desconhecido ao salvar configuração",
                        Duration = 3
                    })
                end
            end
        ...
        SettingsTab.Button({
            Name = "Load Config",
            Callback = function()
                local success, message = Linux.LoadConfig(Linux.CurrentConfig)
                if success then
                    Linux:Notify({
                        Title = "Configuração Carregada",
                        Content = "Configuração '" .. Linux.CurrentConfig .. "' carregada com sucesso!",
                        Duration = 3
                    })
                else
                    Linux:Notify({
                        Title = "Erro ao Carregar",
                        Content = message or "Erro desconhecido ao carregar configuração",
                        Duration = 3
                    })
                end
            end
        ...
        SettingsTab.Button({
            Name = "Delete Config",
            Callback = function()
                local success, message = Linux.DeleteConfig(Linux.CurrentConfig)
                if success then
                    Linux:Notify({
                        Title = "Configuração Excluída",
                        Content = "Configuração '" .. Linux.CurrentConfig .. "' excluída com sucesso!",
                        Duration = 3
                    })
                    ...
                    Linux:Notify({
                        ...
                        Content = message or "Erro desconhecido ao excluir configuração",
                        Duration = 3
                    })
                end
            end
        ...
        SettingsTab.Section({Name = "Informações"})
        
        SettingsTab.Paragraph({
            Title = "Sobre o Sistema de Salvamento",
            Content = "O sistema de salvamento permite que você salve e carregue configurações específicas para este jogador. As configurações são salvas localmente e serão mantidas entre sessões."
        })
