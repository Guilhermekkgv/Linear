...
function Linux.Create(config)
    ...
    if config.ConfigSave ~= false then
        ...
        SettingsTab.Section({Name = "Information"})
        
        SettingsTab.Paragraph({
            Title = "About the Save System",
            Content = "The save system allows you to save and load specific configurations for this player. Configurations are saved locally and will be maintained between sessions."
        })
    end
